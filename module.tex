\documentclass[11pt,oneside]{udthesis}
...
\def \Prodi{prody name}
\def \Fak{faculty name}
\def \Course{course name}
\def \CourseId{course id}
\def \Author{Author 1}
\def \ndAuthor{Author 2}
\def \rdAuthor{Author 3}
\def \thAuthor{Author 4}
\def \yourHead{<firstname lastname>}
\def \yourNipHead{<xxxxxxxxx xxxxxxxx>}
\def \yourSecHead{<firstname lastname>}
\def \yourNipSecHead{<xxxxxxxxx xxxxxxxx>}
